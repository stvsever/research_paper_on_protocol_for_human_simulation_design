...
| --- | --- | --- | --- | --- |
| AIID: The Attitudes, Identities, and Individual Differences Study and Dataset | Individual differences, social attitudes, identities, psychometrics | Person-level social and personality measures (explicit attitudes, identities, motivations, beliefs, individual differences) collected via Project Implicit; N > 200,000 | Mandatory primary dataset for inter-individual heterogeneity | Confirmatory subset downloaded to `src/data/raw/aiid/` |
...
| --- | --- | --- |
| AIID OSF project | OSF wiki and data component checked; confirmatory subset downloaded; title, contributors, DOI, and CC0 license confirmed from OSF project metadata | DOI: `10.17605/OSF.IO/PCJWF`; persistent URL: https://osf.io/pcjwf/ |
...
1. Hussey, I., Hughes, S., Lai, C. K., Ebersole, C. R., Axt, J., & Nosek, B. A. (2012). *The Attitudes, Identities, and Individual Differences (AIID) Study and Dataset*. Open Science Framework. https://doi.org/10.17605/OSF.IO/PCJWF
